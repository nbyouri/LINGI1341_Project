...
# Fichier au contenu aléatoire de 20000 octets
dd if=/dev/urandom of=input_file bs=1 count=10000000 &> /dev/null
...
if ! ./sender localhost 2456 < input_file 2> sender.log ; then
